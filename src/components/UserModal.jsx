...
const UserModal = () => {
  ...
  return (
    <div className="w-full max-w-screen overflow-x-hidden">
      ...
      <button className='lg:w-[500px] w-[300px] cursor-pointer mb-[50px] lg:mb-6 mt-2 p-1.5 rounded-sm text-[12px] bg-emerald-400'>Enrol {client.username} to a program</button>
      </div>
